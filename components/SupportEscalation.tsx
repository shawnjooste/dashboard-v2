 ...
 *  has no timeframe.
 *
 *  Rendered twice, exactly one visible at any width: collapsed behind a
 *  disclosure on a phone (so the tickets themselves sit above the fold) and
 *  always open on desktop. Two wrappers rather than one, because `open` is an
 *  HTML attribute and CSS cannot set it per-breakpoint. */
